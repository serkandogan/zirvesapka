...
<div class="portlet box green">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-cogs"></i>Tedarikçilerin Listesi
        </div>
        <div class="tools">
    ...
    <div class="portlet-body flip-scroll">
        ...
        <tr>
            <td>
                 <a href="{{ url('admin/suppliers/'.$supplier->ID) }}">{{ $supplier->ID }}</a>
            </td>
            <td>
                 {{ $supplier->Baslik }}
            </td>
            <td class="numeric">
               <a href="{{ url('admin/suppliers/'.$supplier->ID.'/edit') }}" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Düzenle">
                    <i class="fa fa-edit"></i>
               </a>

                <a href="{!! route('admin.suppliers.destroy', $supplier->ID) !!}" data-method="DELETE" data-token="{{ csrf_token() }}" data-confirm="ürün" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Sil"><i class="fa fa-trash"></i></a>
