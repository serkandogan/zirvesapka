    ...
    var e = function () {
        ...
        e.dataTable({
            language: {
                ...
                info: "_START_ den _END_ e _TOTAL_ kadar",
                infoEmpty: "No records found",
                infoFiltered: "(filtered1 from _MAX_ total records)",
                lengthMenu: "Sıralama _MENU_",
                search: "Arama Yap:",
                zeroRecords: "No matching records found",
                paginate: {previous: "Geri", next: "İleri", last: "Son", first: "İleri"}
            },
            bStateSave: !0,
        ...
        e.dataTable({
            language: {
                ...
                zeroRecords: "No matching records found",
                paginate: {previous: "Prev", next: "Next", last: "Last", first: "First"}
            }, bStateSave: !0, lengthMenu: [[6, 15, 20, -1], [6, 15, 20, "All"]], pageLength: 6, columnDefs: [{orderable: !1, targets: [0]}, {searchable: !1, targets: [0]}], order: [[1, "asc"]]
        });
