...
<div class="row">
{!! Form::model($product, ['action'=>['Admin\ProductsController@postCreate2', $product->ID], 'files'=>true, 'method'=>'POST']) !!}
            ...
            <div class="col-md-6">
                <div class="portlet light bordered">
                        ...
                        <div class="form-body">
                            <div class="form-body">
                                <div class="form-group last">
                                    {!! Form::textarea('Icerik', null, ['class' => 'ckeditor form-control']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="portlet-title">
                        ...
                        <div class="form-group">
                           <button type="submit" class="btn btn-danger">Ürünü Ekle</button>
                        </div>
                    </div>  
                </div>
            </div> 
