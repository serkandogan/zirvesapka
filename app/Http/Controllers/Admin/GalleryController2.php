...
class GalleryController2 extends AdminController {
	
	public function getIndex(){
		$images = GalleryGroup::all();
		return view('admin.pagess.gallery.index', compact('images'));
	}
	...
	public function getImage($id){
		...
		return view('admin.pagess.gallery.image', compact('product', 'gallery'));
	}
	...
	public function getChangeimg($id, $urun){
		...
		return view('admin.pagess.gallery.changeimg', compact('changeimg'));
	}
	...
	public function getDelete($id, $urun) {
		...
		if (count($delete)>0) {
			...
			if( ! $delete->delete()){
				...
				return redirect()->back()->with('delete', 0);
			}
		}
	}
