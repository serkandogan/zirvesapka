...
<div class="portlet box green">
    ...
    <div class="portlet-body flip-scroll">
        ...
        <tr>
            <td>
                 <a href="{{ url('admin/brands/'.$brand->ID) }}">{{ $brand->ID }}</a>
            </td>
            <td>
                 {{ $brand->Baslik }}
            </td>
            <td class="numeric">
               <a href="{{ url('admin/brands/'.$brand->ID.'/edit') }}" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Düzenle">
                    <i class="fa fa-edit"></i>
               </a>

                <a href="{!! route('admin.brands.destroy', $brand->ID) !!}" data-method="DELETE" data-token="{{ csrf_token() }}" data-confirm="ürün" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Sil"><i class="fa fa-trash"></i></a>
