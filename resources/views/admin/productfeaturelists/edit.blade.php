...
@section('content')
    ...
    @include('admin._partials.breadcrumb', ['category' => 'Ürün Özellikleri', 'page' => 'Ürün Özellikleri Düzenle'])
            ...
            <div class="row">
                <div class="col-md-12">
                    {!! Form::model($productfeaturelist, ['class' => 'form-horizontal', 'id' => 'productfeaturelist-update', 'files' => true, 'method' => 'PUT', 'route' => ['admin.productfeaturelists.update', $productfeaturelist->ID]]) !!}
